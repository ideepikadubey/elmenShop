    ...
    <footer style={{ background: '#090909', borderTop: '1px solid #1c1c1c', padding: '60px 0 30px', color: '#fff' }}>
      <div className="container">
        ...
        <div style={{
          ...
          <a href="#my-orders" onClick={(e) => { e.preventDefault(); window.dispatchEvent(new CustomEvent('elmen:openMyOrders')); }} style={{ color: '#aaa', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--primary-yellow)'} onMouseLeave={(e) => e.currentTarget.style.color = '#aaa'}>My Orders</a>
